...
export const FLOWS: Record<Mode, Flow> = {
  lote: {
    ...
    import: {
      ...
      folder: true,
      link: true,
      linkPlaceholder: "https://... TikTok, X, Reddit, Vimeo, Streamable ou arquivo direto",
      linkHint:
        "cada link vira mais um item do lote. tiktok · x/twitter · reddit · vimeo · streamable · arquivos diretos.",
      multiple: true,
  ...
  clip: {
    ...
    import: {
      ...
      linkHint:
        "importa direto de tiktok · x/twitter · reddit · vimeo · streamable · links diretos de arquivo.",
      multiple: true,
